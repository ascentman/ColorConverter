...
public struct ColorMatrix3 {
    public let redx: Double
    public let redy: Double
    public let redBrightness: Double
    public let greenx: Double
    public let greeny: Double
    public let greenBrightness: Double
    public let bluex: Double
    public let bluey: Double
    public let blueBrightness: Double
}

public class GenericRGBColorModel: GenericSubColor {
    ...
    public init(userColorMatrix: ColorMatrix3) {
    ...
    public var relativeBrightness: Double {
        get {
